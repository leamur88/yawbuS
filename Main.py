...
pygame.display.set_caption("pics/Sandwich Time")
pygame.init()
...
#bread
GR = Ingredients("pics/Golden Retriever.png", "bread", 'g', 2)
Huskie = Ingredients("pics/Huskie.png", "bread", 'h', 3)
Dachshund = Ingredients("pics/Dachshund.png", "bread", 'd', 1)
